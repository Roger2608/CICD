...
from model.api.proxy.repository_proxy import invoice_create_new_repository
...
def create_new_repository(repository_request: RequestGenerateRepository):
    ...
    response_call_api_bitbucket = invoice_create_new_repository(workspace=workspace,
